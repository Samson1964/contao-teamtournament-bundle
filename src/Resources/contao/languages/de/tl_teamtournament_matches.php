...
// Eingabemaske
$GLOBALS['TL_LANG']['tl_teamtournament_matches']['team_legend'] = 'Mannschaften';
$GLOBALS['TL_LANG']['tl_teamtournament_matches']['team1'] = array('Mannschaftsname 1', 'Name der ersten Mannschaft');
$GLOBALS['TL_LANG']['tl_teamtournament_matches']['team2'] = array('Mannschaftsname 2', 'Name der zweiten Mannschaft');

$GLOBALS['TL_LANG']['tl_teamtournament_matches']['round_legend'] = 'Runde und Tisch';
$GLOBALS['TL_LANG']['tl_teamtournament_matches']['round'] = array('Runde', 'Nummer der Runde');
